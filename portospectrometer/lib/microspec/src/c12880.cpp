...
void C12880_Class::begin()
{
    ...
    _adc->setAveraging(4);   // set number of averages
    ...
    _adc->setConversionSpeed(ADC_CONVERSION_SPEED::HIGH_SPEED_16BITS); //HIGH_SPEED_16BITS); // change the conversion speed
    // it can be VERY_LOW_SPEED, LOW_SPEED, MED_SPEED, HIGH_SPEED or VERY_HIGH_SPEED
    _adc->setSamplingSpeed(ADC_SAMPLING_SPEED::HIGH_SPEED); //HIGH_SPEED); // change the sampling speed
#else
